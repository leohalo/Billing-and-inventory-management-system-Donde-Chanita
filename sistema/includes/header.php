...
<head>
	...
	<title>Sistema de Venta Donde Chanita</title>
			...
			<div class="container-fluid d-flex align-items-center justify-content-between">
				<div class="navbar-header">
					<!-- Navbar Header--><a href="index.php" class="navbar-brand">
						<div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">Donde</strong><strong>Chanita</strong></div>
						<div class="brand-text brand-sm"><strong class="text-primary">D</strong><strong>C</strong></div>
					</a>
					<!-- Sidebar Toggle Btn-->
					<button class="sidebar-toggle"><i class="fas fa-bars"></i></button>
				</div>
				<h4><?php echo fechaColombia(); echo date(" / h:i:s a  ");; ?></h4>
	...
	<div class="d-flex align-items-stretch">
		...
		<nav id="sidebar">
			...
			<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
				...
				<li class="nav-item">
					...
					<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							...
							<a class="collapse-item" href="ventas.php">Ventas y Facturas</a>
						</div>
					</div>
				</li>
				...
				<li class="nav-item">
					...
					<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							...
							<a class="collapse-item" href="lista_productos.php">Lista de Productos</a>
						</div>
					</div>
				</li>
				...
				<li class="nav-item">
					...
					<div id="collapseClientes" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							...
							<a class="collapse-item" href="lista_cliente.php">Lista de Clientes</a>
						</div>
					</div>
				</li>
				...
				<li class="nav-item">
					...
					<div id="collapseProveedor" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							...
							<a class="collapse-item" href="lista_proveedor.php">Lista de Proveedores</a>
						</div>
					</div>
				</li>
				...
				<?php } ?>
				<li class="nav-item">
					<a class="nav-link" href="stock.php" aria-expanded="true">
						<i class="fas fa-fw fa-wrench"></i>
						<span>Stock minimo o agotado</span>
					</a>
				</li>
				...
				<li class="nav-item">
					<a class="nav-link" href="reporte.php" aria-expanded="true">
						<i class="fas fa-tools"></i>
